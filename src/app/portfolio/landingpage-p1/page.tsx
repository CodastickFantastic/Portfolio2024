...
export const metadata: Metadata = {
    title: 'Landing Page',
    description: 'Projekt strony landing page dla firmy zajmującej się wynajmem apartamentów',
    keywords: ["Landing page", "Strona landing page", "Strona landing page dla firmy wynajmującej apartamenty",
    ],
    alternates: {
        canonical: 'https://jakubwojtysiak.online/portfolio/landingpage-p1',
        languages: {
        ...
        <main className={`${styles.projectPage} container`}>
            <section className={styles.header}>
                <div className={styles.left}>
                    <ProjectHeader
                        title="Landing Page"
                        info="Projekt strony landing page dla firmy zajmującej się wynajmem apartamentów"
                        bullets={["Projekt Figma", "Rezerwacaja Online", "Booking"]}
                        technologies="Figma"
                        time="1 dzień"
                    />
                </div>
